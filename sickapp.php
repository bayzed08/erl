...
<head>
    ...
    <script language="javascript">
        function printDiv(dreport) {
            ...
            document.title = 'Sickleave-<?php echo date("d-m-Y").'_'.date("h_i") ?>';
            window.print();
                        ...
                        <form id="ssdreportform" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                            <div class="form-group" style="width:100%;">
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <input class="form-control" id="search" name="search" type="text" placeholder="User Name" autocomplete="off">
                                        <div id="result"></div>
