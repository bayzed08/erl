...
<head>
    ...
    <style>
        tr:hover{background-color:#e5e5e5;height:35px;}
    </style>
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-12 text-left" id="ackshowprintandDelete">
                    ...
                    <div id="acktabshow" style="display:none;background-color:#c4c5c7;padding:10px;border-radius:15px;box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
                        <?php 
                      $sql555="SELECT aa.entrydate IssueDate,
                    ...
                    <div class="modal fade" tabindex="-1" role="dialog" id="ReportAckData">
                        <div class="modal-dialog" style="width:60%;">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal" id="Nobtn">Close</button>
                                    <button type="button" class="btn btn-default" id='printcmd'>Print</button>
                                </div>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
                    </div>
            ...
            <script language="javascript" type="text/javascript">
                function printDiv(dreport) {
                    ...
                    document.title = 'acknowledgement-<?php echo date("d-m-Y").'_'.date("h_i") ?>';
                    window.print();
