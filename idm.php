                    ...
                    <div>
                        <form id="idmappform" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" id="sendernamesearch" name="sendernamesearch" type="text" autocomplete="off">
                                    <div id="result"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" id="receivernamesearch" name="receivernamesearch" type="text" autocomplete="off">
                                    <div id="result2"></div>
                                    <script type="text/javascript" src="custom/js/acknowledge.js">
                                    </script>
                                </div>
